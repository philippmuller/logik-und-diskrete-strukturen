...
\grade{2/4: a korrekt, b nicht, c unvollständig (Gleichung nicht vereinfacht)}
\begin{enumerate}[a)]
\item
...
\grade{2/4: Strukturelle Induktion fehlt}
\begin{enumerate}
  ...
  \begin{align*}
    ...
    &\iff \exists k, \; \text{sodass} \; w^R \in L_1^k \\
    &\iff \exists k, \; \text{sodass} \; w \in (L_1^k)^R = (L_1^R)^k \\
